...
## Plan E — 🌏 OpenAI-Compatible (silra.cn)

**For users with silra.cn API access**

- Embedding: `text-embedding-v4` (1024-dim)
- Reranker: `qwen3-reranker-8b` (cross-encoder)
- LLM: OpenAI `gpt-4o-mini` or any available
- Keys needed: `SILRA_API_KEY` + `OPENAI_API_KEY`
- Get key: silra.cn dashboard
- Cost: silra.cn pricing
- Best for: Users with silra.cn API access
      ...
      "memory-lancedb-pro": {
        "config": {
          ...
          "retrieval": {
            ...
            "rerankEndpoint": "https://api.silra.cn/v1/rerank",
            "rerankApiKey": "${SILRA_API_KEY}"
          }
        }
      }
    }
...
echo "✅ Plan E (OpenAI-Compatible/silra.cn) 已添加到 SKILL.md"
